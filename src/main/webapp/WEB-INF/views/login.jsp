...
<title>开发者DEMO</title>
<link rel="stylesheet" type="text/css" href="themes/css/bootstrap.css" media="screen" />
<script type="text/javascript" src="js/viewui/lib/jquery/jquery.min.js"></script>
<style type="text/css">
.top-banner {
	height: 56px;
	position: absolute;
	background: url('themes/demoimg/header.png') repeat-x;
	width: 100%;
...
.bottom-banner {
	background: url('themes/demoimg/footer.png') repeat-x;
	height: 56px;
	width: 100%;
	...
	<div class="center-banner">
		<div class="login-box" id="logon-box">
			<form action="${pageContext.request.contextPath}/login" method="post" id="login_form" class="login-form">
				<div class="top-panel">
					<img src="themes/demoimg/lockscreen.png" /> DEMO管理系统 
				</div>
				<div class="center-panel">
					<div class="left">
						<img src="themes/demoimg/login.png" />
					</div>
					<div class="right">
						<div class="form-row">
						...
						<div class="form-row">
							<div class="input-prepend">
								<span class="add-on"><i class="icon-lock"></i></span><input type="password" id="password" name="password" placeholder="Password" value="123" style="height:16px"/>
							</div>
						</div>
		...
		<div id="forrgotpass-box" class="login-box" style="display: none">
			<div class="top-panel">
				<img src="themes/demoimg/lockscreen.png" alt="" /> 忘记密码
			</div>
			<div class="alert alert-info alert-login" style="width: 74%" >请输入您的邮箱地址，你会收到一封修改新密码的邮件。</div>
			<form method="post" class="login-form">
				<div class="center-panel" style="height: auto">
					<div class="form-row">
						<div class="center">
							<div class="input-prepend">
								<span class="add-on">@</span><input type="text" name="email" placeholder="Your email address" style="height:16px" />
							</div>
						</div>
					</div>
				</div>
